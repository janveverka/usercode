...
options.inputFiles = ["file:/raid6/veverka/Wgamma/ElectronPhotonVGammaSkim/a81f4ee10ef188fe6a5700e98d7864f7/VGammaPAT_ElectronPhotonSkim_8_1_Nkd.root"]
options.outputFile = "bumpTree.root"
...
process.load("Misc.Higgs.EasterBumpSequence_cff")

process.p = cms.Path( process.EasterBumpSequence )
