...
# with command line options: SingleGammaPt35_cfi.py -s GEN,FASTSIM,HLT:GRun --pileup=NoPileUp --geometry DB --conditions=auto:mc --eventcontent=FEVTSIM --datatier GEN-SIM-DIGI-RECO -n 1 --fileout file:fastsim.root --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('SingleGammaPt35_cfi.py nevts:1'),
