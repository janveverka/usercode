...
process.mumuGammaPath = process.dimuonsPath.copy()
process.mumuGammaPath += process.patDefaultSequence
process.mumuGammaPath *= process.mumuGammaSequence

process.mumuGammaOneTrackPath = process.dimuonsOneTrackPath.copy()
process.mumuGammaOneTrackPath += process.patDefaultSequence
process.mumuGammaOneTrackPath *= process.mumuGammaOneTrackSequence
...
process.out.fileName = 'testZMuMuSubskim.root'
