/**
 * \file FWLite/Tools/interface/ArgParser.h
 * \brief Command Line Parser by Alex Mott
 * Copied from UserCode/amott/CaltechApp/include/ArgParser.hh?revision=1.3
 * in http://cmssw.cvs.cern.ch/cgi-bin/cmssw.cgi
 * \author Alex Mott, Jan Veverka, Caltech
 * \date 14 September 2012
 */

#ifndef FWLite_Tools_interface_ArgParser_h
#define FWLite_Tools_interface_ArgParser_h
