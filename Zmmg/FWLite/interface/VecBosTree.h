...
// Tue Jun 12 04:57:25 2012 by ROOT version 5.27/06b
// from TChain ntp1/
//////////////////////////////////////////////////////////

#ifndef ZMMG_FWLITE_VECBOSTREE_H
#define ZMMG_FWLITE_VECBOSTREE_H
...
namespace cit {
  ...
  public :
    ...
    Int_t           indexPassing[451];   //[nTriggerObsPassing]
    Int_t           indexPassingPerPath[453];   //[nTriggerPaths]
    Int_t           nTriggerObs;
    Float_t         triggerObsPt[984];   //[nTriggerObs]
    Float_t         triggerObsPhi[984];   //[nTriggerObs]
    Float_t         triggerObsEta[984];   //[nTriggerObs]
    Float_t         triggerObsMass[984];   //[nTriggerObs]
    Int_t           nEle;
    ...
    Float_t         pfCandChargedIso01Ele[5];   //[nEle]
    Float_t         pfCandNeutralIso01Ele[5];   //[nEle]
    Float_t         pfCandPhotonIso01Ele[5];   //[nEle]
    Float_t         pfCandChargedIso02Ele[5];   //[nEle]
    Float_t         pfCandNeutralIso02Ele[5];   //[nEle]
    Float_t         pfCandPhotonIso02Ele[5];   //[nEle]
    ...
    Float_t         pfCandChargedIso05Ele[5];   //[nEle]
    Float_t         pfCandNeutralIso05Ele[5];   //[nEle]
    Float_t         pfCandPhotonIso05Ele[5];   //[nEle]
    Float_t         pfCandChargedIso06Ele[5];   //[nEle]
    Float_t         pfCandNeutralIso06Ele[5];   //[nEle]
    Float_t         pfCandPhotonIso06Ele[5];   //[nEle]
    Float_t         pfCandChargedIso07Ele[5];   //[nEle]
    Float_t         pfCandNeutralIso07Ele[5];   //[nEle]
    Float_t         pfCandPhotonIso07Ele[5];   //[nEle]
    Float_t         pfCandChargedDirIso04Ele[5];   //[nEle]
    Float_t         pfCandNeutralDirIso04Ele[5];   //[nEle]
    Float_t         pfCandPhotonDirIso04Ele[5];   //[nEle]
    Int_t           nPho;
    Int_t           nPerPVPho;
    Int_t           chargePho[9];   //[nPho]
    Float_t         energyPho[9];   //[nPho]
    Float_t         thetaPho[9];   //[nPho]
    Float_t         etaPho[9];   //[nPho]
    Float_t         phiPho[9];   //[nPho]
    Float_t         pxPho[9];   //[nPho]
    Float_t         pyPho[9];   //[nPho]
    Float_t         pzPho[9];   //[nPho]
    Float_t         vertexXPho[9];   //[nPho]
    Float_t         vertexYPho[9];   //[nPho]
    Float_t         vertexZPho[9];   //[nPho]
    Int_t           fiducialFlagsPho[9];   //[nPho]
    Int_t           recoFlagsPho[9];   //[nPho]
    Int_t           superClusterIndexPho[9];   //[nPho]
    Int_t           PFsuperClusterIndexPho[9];   //[nPho]
    Float_t         hOverEPho[9];   //[nPho]
    Float_t         hTowOverEPho[9];   //[nPho]
    Float_t         dr03TkSumPtPho[9];   //[nPho]
    Float_t         dr03HollowTkSumPtPho[9];   //[nPho]
    Float_t         dr03EcalRecHitSumEtPho[9];   //[nPho]
    Float_t         dr03HcalTowerSumEtPho[9];   //[nPho]
    Float_t         dr04TkSumPtPho[9];   //[nPho]
    Float_t         dr04HollowTkSumPtPho[9];   //[nPho]
    Float_t         dr04EcalRecHitSumEtPho[9];   //[nPho]
    Float_t         dr04HcalTowerSumEtPho[9];   //[nPho]
    Float_t         chargedHadronIsoPho[9];   //[nPho]
    Float_t         neutralHadronIsoPho[9];   //[nPho]
    Float_t         photonIsoPho[9];   //[nPho]
    Int_t           hasPixelSeedPho[9];   //[nPho]
    Bool_t          hasMatchedConversionPho[9];   //[nPho]
    Float_t         dr03nhPFIsoPho[9];   //[nPho]
    Float_t         dr03phPFIsoPho[9];   //[nPho]
    Float_t         dr03chPFIsoPho[288];   //[nPerPVPho]
    Int_t           nConv;
    Float_t         pxPairConv[47];   //[nConv]
    Float_t         pyPairConv[47];   //[nConv]
    Float_t         pzPairConv[47];   //[nConv]
    Float_t         pxRefittedPairConv[47];   //[nConv]
    Float_t         pyRefittedPairConv[47];   //[nConv]
    Float_t         pzRefittedPairConv[47];   //[nConv]
    Float_t         etaRefittedPairConv[47];   //[nConv]
    Float_t         phiRefittedPairConv[47];   //[nConv]
    Float_t         ptRefittedPairConv[47];   //[nConv]
    Float_t         energyRefittedPairConv[47];   //[nConv]
    Float_t         eOverPRefittedPairConv[47];   //[nConv]
    Float_t         zOfPVFromTracksConv[47];   //[nConv]
    Float_t         xVtxConv[47];   //[nConv]
    Float_t         yVtxConv[47];   //[nConv]
    Float_t         zVtxConv[47];   //[nConv]
    Float_t         chi2VtxConv[47];   //[nConv]
    Float_t         chi2ProbVtxConv[47];   //[nConv]
    Int_t           isValidVtxConv[47];   //[nConv]
    Int_t           nTracksVtxConv[47];   //[nConv]
    Float_t         mvaOutVtxConv[47];   //[nConv]
    Float_t         trk1DzConv[47];   //[nConv]
    Float_t         trk1DzErrorConv[47];   //[nConv]
    Float_t         trk1ChargeConv[47];   //[nConv]
    Float_t         trk1AlgoConv[47];   //[nConv]
    Float_t         trk1PtConv[47];   //[nConv]
    Float_t         trk1D0Conv[47];   //[nConv]
    Float_t         trk1PoutConv[47];   //[nConv]
    Float_t         trk1PinConv[47];   //[nConv]
    Float_t         trk2DzConv[47];   //[nConv]
    Float_t         trk2DzErrorConv[47];   //[nConv]
    Float_t         trk2ChargeConv[47];   //[nConv]
    Float_t         trk2AlgoConv[47];   //[nConv]
    Float_t         trk2PtConv[47];   //[nConv]
    Float_t         trk2D0Conv[47];   //[nConv]
    Float_t         trk2PoutConv[47];   //[nConv]
    Float_t         trk2PinConv[47];   //[nConv]
    Int_t           nSC;
    Int_t           nBCSC[104];   //[nSC]
    Int_t           nCrystalsSC[104];   //[nSC]
    Float_t         rawEnergySC[104];   //[nSC]
    Float_t         energySC[104];   //[nSC]
    Float_t         seedClusterEnergySC[104];   //[nSC]
    Float_t         esEnergySC[104];   //[nSC]
    Float_t         etaSC[104];   //[nSC]
    Float_t         thetaSC[104];   //[nSC]
    Float_t         phiSC[104];   //[nSC]
    Float_t         xPosSC[104];   //[nSC]
    Float_t         yPosSC[104];   //[nSC]
    Float_t         zPosSC[104];   //[nSC]
    Float_t         phiWidthSC[104];   //[nSC]
    Float_t         etaWidthSC[104];   //[nSC]
    Float_t         e3x3SC[104];   //[nSC]
    Float_t         e3x1SC[104];   //[nSC]
    Float_t         e1x3SC[104];   //[nSC]
    Float_t         e4x4SC[104];   //[nSC]
    Float_t         e5x5SC[104];   //[nSC]
    Float_t         eMaxSC[104];   //[nSC]
    Float_t         e2x2SC[104];   //[nSC]
    Float_t         e2ndSC[104];   //[nSC]
    Float_t         e1x5SC[104];   //[nSC]
    Float_t         e2x5MaxSC[104];   //[nSC]
    Float_t         e2x5LeftSC[104];   //[nSC]
    Float_t         e2x5RightSC[104];   //[nSC]
    Float_t         e2x5TopSC[104];   //[nSC]
    Float_t         e2x5BottomSC[104];   //[nSC]
    Float_t         eLeftSC[104];   //[nSC]
    Float_t         eRightSC[104];   //[nSC]
    Float_t         eTopSC[104];   //[nSC]
    Float_t         eBottomSC[104];   //[nSC]
    Float_t         e4SwissCrossSC[104];   //[nSC]
    Float_t         covIEtaIEtaSC[104];   //[nSC]
    Float_t         covIEtaIPhiSC[104];   //[nSC]
    Float_t         covIPhiIPhiSC[104];   //[nSC]
    Float_t         sMajSC[104];   //[nSC]
    Float_t         sMinSC[104];   //[nSC]
    Float_t         alphaSC[104];   //[nSC]
    Float_t         hOverESC[104];   //[nSC]
    Int_t           recoFlagSC[104];   //[nSC]
    Float_t         timeSC[104];   //[nSC]
    Float_t         chi2SC[104];   //[nSC]
    Float_t         seedEnergySC[104];   //[nSC]
    Float_t         seedXSC[104];   //[nSC]
    Float_t         seedYSC[104];   //[nSC]
    Float_t         esEffsIxIxSC[104];   //[nSC]
    Float_t         esEffsIyIySC[104];   //[nSC]
    Float_t         esL1EnergySC[104];   //[nSC]
    Float_t         esL2EnergySC[104];   //[nSC]
    Int_t           esL1StripsSC[104];   //[nSC]
    Int_t           esL2StripsSC[104];   //[nSC]
    Int_t           nPFSC;
    ...
    Float_t         sMajPFSC[4];   //[nPFSC]
    Float_t         sMinPFSC[4];   //[nPFSC]
    Float_t         alphaPFSC[4];   //[nPFSC]
    Float_t         hOverEPFSC[4];   //[nPFSC]
    Int_t           recoFlagPFSC[4];   //[nPFSC]
    Float_t         timePFSC[4];   //[nPFSC]
    Float_t         chi2PFSC[4];   //[nPFSC]
    ...
    Int_t           nBC;
    Int_t           nCrystalsBC[331];   //[nBC]
    Float_t         energyBC[331];   //[nBC]
    Float_t         etaBC[331];   //[nBC]
    Float_t         thetaBC[331];   //[nBC]
    Float_t         phiBC[331];   //[nBC]
    Float_t         e3x3BC[331];   //[nBC]
    Float_t         e5x5BC[331];   //[nBC]
    Float_t         eMaxBC[331];   //[nBC]
    Float_t         e2x2BC[331];   //[nBC]
    Float_t         e2ndBC[331];   //[nBC]
    Float_t         eTopBC[331];   //[nBC]
    Float_t         eBottomBC[331];   //[nBC]
    Float_t         eLeftBC[331];   //[nBC]
    Float_t         eRightBC[331];   //[nBC]
    Float_t         e2x5MaxBC[331];   //[nBC]
    Float_t         e2x5TopBC[331];   //[nBC]
    Float_t         e2x5BottomBC[331];   //[nBC]
    Float_t         e2x5LeftBC[331];   //[nBC]
    Float_t         e2x5RightBC[331];   //[nBC]
    Float_t         etaCrystalBC[331];   //[nBC]
    Float_t         phiCrystalBC[331];   //[nBC]
    Int_t           iEtaBC[331];   //[nBC]
    Int_t           iPhiBC[331];   //[nBC]
    Float_t         thetaTiltBC[331];   //[nBC]
    Float_t         phiTiltBC[331];   //[nBC]
    Float_t         covIEtaIEtaBC[331];   //[nBC]
    Float_t         covIEtaIPhiBC[331];   //[nBC]
    Float_t         covIPhiIPhiBC[331];   //[nBC]
    Int_t           recoFlagBC[331];   //[nBC]
    Float_t         timeBC[331];   //[nBC]
    Float_t         chi2BC[331];   //[nBC]
    Float_t         seedEnergyBC[331];   //[nBC]
    Int_t           indexSCBC[331];   //[nBC]
    Int_t           nPFBC;
    Int_t           nCrystalsPFBC[9];   //[nPFBC]
    Float_t         energyPFBC[9];   //[nPFBC]
    Float_t         etaPFBC[9];   //[nPFBC]
    Float_t         thetaPFBC[9];   //[nPFBC]
    Float_t         phiPFBC[9];   //[nPFBC]
    Float_t         e3x3PFBC[9];   //[nPFBC]
    Float_t         e5x5PFBC[9];   //[nPFBC]
    Float_t         eMaxPFBC[9];   //[nPFBC]
    Float_t         e2x2PFBC[9];   //[nPFBC]
    Float_t         e2ndPFBC[9];   //[nPFBC]
    Float_t         eTopPFBC[9];   //[nPFBC]
    Float_t         eBottomPFBC[9];   //[nPFBC]
    Float_t         eLeftPFBC[9];   //[nPFBC]
    Float_t         eRightPFBC[9];   //[nPFBC]
    Float_t         e2x5MaxPFBC[9];   //[nPFBC]
    Float_t         e2x5TopPFBC[9];   //[nPFBC]
    Float_t         e2x5BottomPFBC[9];   //[nPFBC]
    Float_t         e2x5LeftPFBC[9];   //[nPFBC]
    Float_t         e2x5RightPFBC[9];   //[nPFBC]
    ...
    Float_t         covIEtaIEtaPFBC[9];   //[nPFBC]
    Float_t         covIEtaIPhiPFBC[9];   //[nPFBC]
    Float_t         covIPhiIPhiPFBC[9];   //[nPFBC]
    Int_t           recoFlagPFBC[9];   //[nPFBC]
    Float_t         timePFBC[9];   //[nPFBC]
    Float_t         chi2PFBC[9];   //[nPFBC]
    Float_t         seedEnergyPFBC[9];   //[nPFBC]
    Int_t           indexSCPFBC[9];   //[nPFBC]
    Int_t           nTrack;
    Float_t         pxTrack[1447];   //[nTrack]
    Float_t         pyTrack[1447];   //[nTrack]
    Float_t         pzTrack[1447];   //[nTrack]
    Int_t           vtxIndexTrack[1447];   //[nTrack]
    Float_t         vtxWeightTrack[1447];   //[nTrack]
    Float_t         impactPar3DTrack[1447];   //[nTrack]
    Float_t         impactPar3DErrorTrack[1447];   //[nTrack]
    Float_t         transvImpactParTrack[1447];   //[nTrack]
    Float_t         transvImpactParErrorTrack[1447];   //[nTrack]
    Float_t         impactPar3DBiasedTrack[1447];   //[nTrack]
    Float_t         impactPar3DBiasedErrorTrack[1447];   //[nTrack]
    Float_t         transvImpactParBiasedTrack[1447];   //[nTrack]
    Float_t         transvImpactParBiasedErrorTrack[1447];   //[nTrack]
    Float_t         chargeTrack[1447];   //[nTrack]
    Float_t         ptErrorTrack[1447];   //[nTrack]
    Float_t         trackValidHitsTrack[1447];   //[nTrack]
    Float_t         trackLostHitsTrack[1447];   //[nTrack]
    Float_t         trackNormalizedChi2Track[1447];   //[nTrack]
    Int_t           qualityMaskTrack[1447];   //[nTrack]
    Float_t         trackVxTrack[1447];   //[nTrack]
    Float_t         trackVyTrack[1447];   //[nTrack]
    Float_t         trackVzTrack[1447];   //[nTrack]
    Float_t         d0Track[1447];   //[nTrack]
    Float_t         d0ErrorTrack[1447];   //[nTrack]
    Float_t         dzTrack[1447];   //[nTrack]
    Float_t         dzErrorTrack[1447];   //[nTrack]
    Int_t           pixelHitsTrack[1447];   //[nTrack]
    Int_t           trackerLayersWithMeasurementTrack[1447];   //[nTrack]
    Int_t           expInnerLayersTrack[1447];   //[nTrack]
    Int_t           numberOfValidPixelBarrelHitsTrack[1447];   //[nTrack]
    Int_t           numberOfValidPixelEndcapHitsTrack[1447];   //[nTrack]
    Int_t           numberOfValidStripTIBHitsTrack[1447];   //[nTrack]
    Int_t           numberOfValidStripTIDHitsTrack[1447];   //[nTrack]
    Int_t           numberOfValidStripTOBHitsTrack[1447];   //[nTrack]
    Int_t           numberOfValidStripTECHitsTrack[1447];   //[nTrack]
    Int_t           numberOfValidMuonHitsTrack[1447];   //[nTrack]
    Int_t           nGsfTrack;
    Float_t         pxGsfTrack[27];   //[nGsfTrack]
    Float_t         pyGsfTrack[27];   //[nGsfTrack]
    Float_t         pzGsfTrack[27];   //[nGsfTrack]
    Int_t           vtxIndexGsfTrack[27];   //[nGsfTrack]
    Float_t         vtxWeightGsfTrack[27];   //[nGsfTrack]
    Float_t         impactPar3DGsfTrack[27];   //[nGsfTrack]
    Float_t         impactPar3DErrorGsfTrack[27];   //[nGsfTrack]
    Float_t         transvImpactParGsfTrack[27];   //[nGsfTrack]
    Float_t         transvImpactParErrorGsfTrack[27];   //[nGsfTrack]
    Float_t         impactPar3DBiasedGsfTrack[27];   //[nGsfTrack]
    Float_t         impactPar3DBiasedErrorGsfTrack[27];   //[nGsfTrack]
    Float_t         transvImpactParBiasedGsfTrack[27];   //[nGsfTrack]
    Float_t         transvImpactParBiasedErrorGsfTrack[27];   //[nGsfTrack]
    Float_t         chargeGsfTrack[27];   //[nGsfTrack]
    Float_t         ptErrorGsfTrack[27];   //[nGsfTrack]
    Float_t         trackValidHitsGsfTrack[27];   //[nGsfTrack]
    Float_t         trackLostHitsGsfTrack[27];   //[nGsfTrack]
    Float_t         trackNormalizedChi2GsfTrack[27];   //[nGsfTrack]
    Int_t           qualityMaskGsfTrack[27];   //[nGsfTrack]
    Float_t         trackVxGsfTrack[27];   //[nGsfTrack]
    Float_t         trackVyGsfTrack[27];   //[nGsfTrack]
    Float_t         trackVzGsfTrack[27];   //[nGsfTrack]
    Float_t         d0GsfTrack[27];   //[nGsfTrack]
    Float_t         d0ErrorGsfTrack[27];   //[nGsfTrack]
    Float_t         dzGsfTrack[27];   //[nGsfTrack]
    Float_t         dzErrorGsfTrack[27];   //[nGsfTrack]
    Int_t           pixelHitsGsfTrack[27];   //[nGsfTrack]
    Int_t           trackerLayersWithMeasurementGsfTrack[27];   //[nGsfTrack]
    Int_t           expInnerLayersGsfTrack[27];   //[nGsfTrack]
    Int_t           numberOfValidPixelBarrelHitsGsfTrack[27];   //[nGsfTrack]
    Int_t           numberOfValidPixelEndcapHitsGsfTrack[27];   //[nGsfTrack]
    Int_t           numberOfValidStripTIBHitsGsfTrack[27];   //[nGsfTrack]
    Int_t           numberOfValidStripTIDHitsGsfTrack[27];   //[nGsfTrack]
    Int_t           numberOfValidStripTOBHitsGsfTrack[27];   //[nGsfTrack]
    Int_t           numberOfValidStripTECHitsGsfTrack[27];   //[nGsfTrack]
    Int_t           numberOfValidMuonHitsGsfTrack[27];   //[nGsfTrack]
    Int_t           chargeModeGsfTrack[27];   //[nGsfTrack]
    Float_t         pxModeGsfTrack[27];   //[nGsfTrack]
    Float_t         pyModeGsfTrack[27];   //[nGsfTrack]
    Float_t         pzModeGsfTrack[27];   //[nGsfTrack]
    Int_t           nGlobalMuonTrack;
    Float_t         pxGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         pyGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         pzGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Int_t           vtxIndexGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         vtxWeightGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         impactPar3DGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         impactPar3DErrorGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         transvImpactParGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         transvImpactParErrorGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         impactPar3DBiasedGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         impactPar3DBiasedErrorGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         transvImpactParBiasedGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         transvImpactParBiasedErrorGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         chargeGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         ptErrorGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         trackValidHitsGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         trackLostHitsGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         trackNormalizedChi2GlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Int_t           qualityMaskGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         trackVxGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         trackVyGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         trackVzGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         d0GlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         d0ErrorGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         dzGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Float_t         dzErrorGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Int_t           pixelHitsGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Int_t           trackerLayersWithMeasurementGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Int_t           expInnerLayersGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Int_t           numberOfValidPixelBarrelHitsGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Int_t           numberOfValidPixelEndcapHitsGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Int_t           numberOfValidStripTIBHitsGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Int_t           numberOfValidStripTIDHitsGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Int_t           numberOfValidStripTOBHitsGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Int_t           numberOfValidStripTECHitsGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Int_t           numberOfValidMuonHitsGlobalMuonTrack[4];   //[nGlobalMuonTrack]
    Int_t           nSTAMuonTrack;
    ...
    Float_t         d0STAMuonTrack[5];   //[nSTAMuonTrack]
    Float_t         d0ErrorSTAMuonTrack[5];   //[nSTAMuonTrack]
    Float_t         dzSTAMuonTrack[5];   //[nSTAMuonTrack]
    Float_t         dzErrorSTAMuonTrack[5];   //[nSTAMuonTrack]
    Int_t           pixelHitsSTAMuonTrack[5];   //[nSTAMuonTrack]
    Int_t           trackerLayersWithMeasurementSTAMuonTrack[5];   //[nSTAMuonTrack]
    ...
    Int_t           numberOfValidMuonHitsSTAMuonTrack[5];   //[nSTAMuonTrack]
    Int_t           nPV;
    Float_t         PVxPV[42];   //[nPV]
    Float_t         PVyPV[42];   //[nPV]
    Float_t         PVzPV[42];   //[nPV]
    Float_t         PVErrxPV[42];   //[nPV]
    Float_t         PVErryPV[42];   //[nPV]
    Float_t         PVErrzPV[42];   //[nPV]
    Float_t         SumPtPV[42];   //[nPV]
    Float_t         rhoPV[42];   //[nPV]
    Float_t         ndofPV[42];   //[nPV]
    Float_t         chi2PV[42];   //[nPV]
    Float_t         normChi2PV[42];   //[nPV]
    Float_t         pxChMetPV[42];   //[nPV]
    Float_t         pyChMetPV[42];   //[nPV]
    Float_t         pzChMetPV[42];   //[nPV]
    Int_t           isFakePV[42];   //[nPV]
    Int_t           isValidPV[42];   //[nPV]
    Int_t           trackSizePV[42];   //[nPV]
    Int_t           nMuon;
    Int_t           chargeMuon[37];   //[nMuon]
    Float_t         energyMuon[37];   //[nMuon]
    Float_t         thetaMuon[37];   //[nMuon]
    Float_t         etaMuon[37];   //[nMuon]
    Float_t         phiMuon[37];   //[nMuon]
    Float_t         pxMuon[37];   //[nMuon]
    Float_t         pyMuon[37];   //[nMuon]
    Float_t         pzMuon[37];   //[nMuon]
    Float_t         vertexXMuon[37];   //[nMuon]
    Float_t         vertexYMuon[37];   //[nMuon]
    Float_t         vertexZMuon[37];   //[nMuon]
    Int_t           trackIndexMuon[37];   //[nMuon]
    Int_t           standAloneTrackIndexMuon[37];   //[nMuon]
    Int_t           combinedTrackIndexMuon[37];   //[nMuon]
    Int_t           muonIdMuon[37];   //[nMuon]
    Bool_t          pfmuonIdMuon[37];   //[nMuon]
    Int_t           typeMuon[37];   //[nMuon]
    Int_t           numberOfMatchesMuon[37];   //[nMuon]
    Float_t         sumPt03Muon[37];   //[nMuon]
    Float_t         emEt03Muon[37];   //[nMuon]
    Float_t         hadEt03Muon[37];   //[nMuon]
    Float_t         hoEt03Muon[37];   //[nMuon]
    Float_t         nTrk03Muon[37];   //[nMuon]
    Float_t         nJets03Muon[37];   //[nMuon]
    Float_t         sumPt05Muon[37];   //[nMuon]
    Float_t         emEt05Muon[37];   //[nMuon]
    Float_t         hadEt05Muon[37];   //[nMuon]
    Float_t         hoEt05Muon[37];   //[nMuon]
    Float_t         nTrk05Muon[37];   //[nMuon]
    Float_t         nJets05Muon[37];   //[nMuon]
    Float_t         pfCombinedIsoMuon[37];   //[nMuon]
    Float_t         pfCandChargedIso01Muon[37];   //[nMuon]
    Float_t         pfCandNeutralIso01Muon[37];   //[nMuon]
    Float_t         pfCandPhotonIso01Muon[37];   //[nMuon]
    Float_t         pfCandChargedIso02Muon[37];   //[nMuon]
    Float_t         pfCandNeutralIso02Muon[37];   //[nMuon]
    Float_t         pfCandPhotonIso02Muon[37];   //[nMuon]
    Float_t         pfCandChargedIso03Muon[37];   //[nMuon]
    Float_t         pfCandNeutralIso03Muon[37];   //[nMuon]
    Float_t         pfCandPhotonIso03Muon[37];   //[nMuon]
    Float_t         pfCandChargedIso04Muon[37];   //[nMuon]
    Float_t         pfCandNeutralIso04Muon[37];   //[nMuon]
    Float_t         pfCandPhotonIso04Muon[37];   //[nMuon]
    Float_t         pfCandChargedIso05Muon[37];   //[nMuon]
    Float_t         pfCandNeutralIso05Muon[37];   //[nMuon]
    Float_t         pfCandPhotonIso05Muon[37];   //[nMuon]
    Float_t         pfCandChargedIso06Muon[37];   //[nMuon]
    Float_t         pfCandNeutralIso06Muon[37];   //[nMuon]
    Float_t         pfCandPhotonIso06Muon[37];   //[nMuon]
    Float_t         pfCandChargedIso07Muon[37];   //[nMuon]
    Float_t         pfCandNeutralIso07Muon[37];   //[nMuon]
    Float_t         pfCandPhotonIso07Muon[37];   //[nMuon]
    Float_t         pfCandChargedDirIso04Muon[37];   //[nMuon]
    Float_t         pfCandNeutralDirIso04Muon[37];   //[nMuon]
    Float_t         pfCandPhotonDirIso04Muon[37];   //[nMuon]
    Float_t         kinkMuon[37];   //[nMuon]
    Float_t         mvaisoMuon[37];   //[nMuon]
    Float_t         EcalExpDepoMuon[37];   //[nMuon]
    Float_t         HcalExpDepoMuon[37];   //[nMuon]
    Float_t         HoExpDepoMuon[37];   //[nMuon]
    Float_t         emS9Muon[37];   //[nMuon]
    Float_t         hadS9Muon[37];   //[nMuon]
    Float_t         hoS9Muon[37];   //[nMuon]
    Float_t         CaloCompMuon[37];   //[nMuon]
    Int_t           nPFTau;
    Int_t           pfJetIndexPFTau[118];   //[nPFTau]
    Int_t           isNonNullPFTau[118];   //[nPFTau]
    Int_t           chargePFTau[118];   //[nPFTau]
    Float_t         energyPFTau[118];   //[nPFTau]
    Float_t         etPFTau[118];   //[nPFTau]
    Float_t         momentumPFTau[118];   //[nPFTau]
    Float_t         thetaPFTau[118];   //[nPFTau]
    Float_t         etaPFTau[118];   //[nPFTau]
    Float_t         phiPFTau[118];   //[nPFTau]
    Float_t         pxPFTau[118];   //[nPFTau]
    Float_t         pyPFTau[118];   //[nPFTau]
    Float_t         pzPFTau[118];   //[nPFTau]
    Float_t         vertexXPFTau[118];   //[nPFTau]
    Float_t         vertexYPFTau[118];   //[nPFTau]
    Float_t         vertexZPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrByLeadingTrackFindingPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrByLeadingTrackPtCutPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrByLeadingPionPtCutPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrByIsolationPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrByIsolationUsingLeadingPionPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrByTrackIsolationPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrByTrackIsolationUsingLeadingPionPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrByECALIsolationPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrByECALIsolationUsingLeadingPionPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrAgainstMuonPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrAgainstElectronPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrByTaNCPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrByTaNCfrHalfPercentPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrByTaNCfrOnePercentPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrByTaNCfrQuarterPercentPFTau[118];   //[nPFTau]
    Float_t         theTauDiscrByTaNCfrTenthPercentPFTau[118];   //[nPFTau]
    Float_t         isolationPFChargedHadrCandsPtSumPFTau[118];   //[nPFTau]
    Float_t         isolationPFGammaCandsEtSumPFTau[118];   //[nPFTau]
    Float_t         emFractionPFTau[118];   //[nPFTau]
    Float_t         hcalTotOverPLeadPFTau[118];   //[nPFTau]
    Float_t         hcal3x3OverPLeadPFTau[118];   //[nPFTau]
    Float_t         ecalStripSumEOverPLeadPFTau[118];   //[nPFTau]
    Float_t         bremsRecoveryEOverPLeadPFTau[118];   //[nPFTau]
    Float_t         thehpsTauDiscrByLooseElectronRejectionPFTau[118];   //[nPFTau]
    Float_t         thehpsTauDiscrByMediumElectronRejectionPFTau[118];   //[nPFTau]
    Float_t         thehpsTauDiscrByTightElectronRejectionPFTau[118];   //[nPFTau]
    Float_t         thehpsTauDiscrByLooseMuonRejectionPFTau[118];   //[nPFTau]
    Float_t         thehpsTauDiscrByTightMuonRejectionPFTau[118];   //[nPFTau]
    Float_t         thehpsTauDiscrByDecayModeFindingPFTau[118];   //[nPFTau]
    Float_t         thehpsTauDiscrByVLooseIsolationPFTau[118];   //[nPFTau]
    Float_t         thehpsTauDiscrByLooseIsolationPFTau[118];   //[nPFTau]
    Float_t         thehpsTauDiscrByMediumIsolationPFTau[118];   //[nPFTau]
    Float_t         thehpsTauDiscrByTightIsolationPFTau[118];   //[nPFTau]
    Float_t         thehpsTauDiscrByVLooseCombinedIsolationDBSumPtCorrPFTau[118];   //[nPFTau]
    Float_t         thehpsTauDiscrByLooseCombinedIsolationDBSumPtCorrPFTau[118];   //[nPFTau]
    Float_t         thehpsTauDiscrByMediumCombinedIsolationDBSumPtCorrPFTau[118];   //[nPFTau]
    Float_t         thehpsTauDiscrByTightCombinedIsolationDBSumPtCorrPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByLeadingTrackFindingPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByLeadingTrackPtCutPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByLeadingPionPtCutPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByTancPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByTancRawPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByTancVLoosePFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByTancLoosePFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByTancMediumPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByTancTightPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByLooseElectronRejectionPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByMediumElectronRejectionPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByTightElectronRejectionPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByLooseMuonRejectionPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByTightMuonRejectionPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByDecayModeSelectionPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByVLooseIsolationPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByLooseIsolationPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByMediumIsolationPFTau[118];   //[nPFTau]
    Float_t         thehpsTancTausDiscrByTightIsolationPFTau[118];   //[nPFTau]
    Int_t           nReducedPFCand;
    Int_t           chargeReducedPFCand[12];   //[nReducedPFCand]
    Float_t         energyReducedPFCand[12];   //[nReducedPFCand]
    Float_t         thetaReducedPFCand[12];   //[nReducedPFCand]
    Float_t         etaReducedPFCand[12];   //[nReducedPFCand]
    Float_t         phiReducedPFCand[12];   //[nReducedPFCand]
    Float_t         pxReducedPFCand[12];   //[nReducedPFCand]
    Float_t         pyReducedPFCand[12];   //[nReducedPFCand]
    Float_t         pzReducedPFCand[12];   //[nReducedPFCand]
    Float_t         vertexXReducedPFCand[12];   //[nReducedPFCand]
    Float_t         vertexYReducedPFCand[12];   //[nReducedPFCand]
    Float_t         vertexZReducedPFCand[12];   //[nReducedPFCand]
    Int_t           nMet;
    ...
    Int_t           nAK5Jet;
    Int_t           chargeAK5Jet[110];   //[nAK5Jet]
    Float_t         energyAK5Jet[110];   //[nAK5Jet]
    Float_t         thetaAK5Jet[110];   //[nAK5Jet]
    Float_t         etaAK5Jet[110];   //[nAK5Jet]
    Float_t         phiAK5Jet[110];   //[nAK5Jet]
    Float_t         pxAK5Jet[110];   //[nAK5Jet]
    Float_t         pyAK5Jet[110];   //[nAK5Jet]
    Float_t         pzAK5Jet[110];   //[nAK5Jet]
    Float_t         vertexXAK5Jet[110];   //[nAK5Jet]
    Float_t         vertexYAK5Jet[110];   //[nAK5Jet]
    Float_t         vertexZAK5Jet[110];   //[nAK5Jet]
    Float_t         emFracAK5Jet[110];   //[nAK5Jet]
    Float_t         hadFracAK5Jet[110];   //[nAK5Jet]
    Float_t         areaAK5Jet[110];   //[nAK5Jet]
    Int_t           IdAK5Jet[110];   //[nAK5Jet]
    Int_t           nHitAK5Jet[110];   //[nAK5Jet]
    Int_t           nHit90AK5Jet[110];   //[nAK5Jet]
    Float_t         fHPDAK5Jet[110];   //[nAK5Jet]
    Float_t         covEtaEtaAK5Jet[110];   //[nAK5Jet]
    Float_t         covPhiPhiAK5Jet[110];   //[nAK5Jet]
    Float_t         fLSAK5Jet[110];   //[nAK5Jet]
    Float_t         fOOTAK5Jet[110];   //[nAK5Jet]
    Float_t         combinedSecondaryVertexBJetTagsAK5Jet[110];   //[nAK5Jet]
    Float_t         simpleSecondaryVertexHighEffBJetTagsAK5Jet[110];   //[nAK5Jet]
    Float_t         simpleSecondaryVertexHighPurBJetTagsAK5Jet[110];   //[nAK5Jet]
    Float_t         trackCountingHighPurBJetTagsAK5Jet[110];   //[nAK5Jet]
    Float_t         trackCountingHighEffBJetTagsAK5Jet[110];   //[nAK5Jet]
    Float_t         trackCountingVeryHighEffBJetTagsAK5Jet[110];   //[nAK5Jet]
    Float_t         uncorrEnergyAK5Jet[110];   //[nAK5Jet]
    Int_t           nAK5PFNoPUJet;
    Int_t           chargeAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         energyAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         uncorrenergyAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         thetaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         etaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         phiAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         pxAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         pyAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         pzAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         uncorrpxAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         uncorrpyAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         uncorrpzAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         vertexXAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         vertexYAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         vertexZAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         chargedHadronEnergyAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         neutralHadronEnergyAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         photonEnergyAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         electronEnergyAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         muonEnergyAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         HFHadronEnergyAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         HFEMEnergyAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Int_t           chargedHadronMultiplicityAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Int_t           neutralHadronMultiplicityAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Int_t           photonMultiplicityAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Int_t           electronMultiplicityAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Int_t           muonMultiplicityAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Int_t           HFHadronMultiplicityAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Int_t           HFEMMultiplicityAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         areaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         weightedDz1AK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         weightedDz2AK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         betastarAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         rmsCandsHandAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         jetIdMvaSimpleAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         jetIdMvaFullAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         jetIdMvaPhilV1AK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         nChargedIdMvaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         nNeutralsIdMvaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         dZIdMvaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         dR2MeanIdMvaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         dRMeanIdMvaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         frac01IdMvaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         frac02IdMvaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         frac03IdMvaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         frac04IdMvaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         frac05IdMvaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         betaIdMvaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         betastarIdMvaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         betastarclassicIdMvaAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         chargedEmEnergyAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         neutralEmEnergyAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         combinedSecondaryVertexBJetTagsAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         combinedSecondaryVertexMVABJetTagsAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         jetBProbabilityBJetTagsAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         jetProbabilityBJetTagsAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         simpleSecondaryVertexHighEffBJetTagsAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         simpleSecondaryVertexHighPurBJetTagsAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         trackCountingHighPurBJetTagsAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         trackCountingHighEffBJetTagsAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         trackCountingVeryHighEffBJetTagsAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         rmsCandAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Float_t         ptDAK5PFNoPUJet[102];   //[nAK5PFNoPUJet]
    Int_t           nAK5PFPUcorrJet;
    Int_t           chargeAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         energyAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         uncorrenergyAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         thetaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         etaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         phiAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         pxAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         pyAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         pzAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         uncorrpxAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         uncorrpyAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         uncorrpzAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         vertexXAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         vertexYAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         vertexZAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         chargedHadronEnergyAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         neutralHadronEnergyAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         photonEnergyAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         electronEnergyAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         muonEnergyAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         HFHadronEnergyAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         HFEMEnergyAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Int_t           chargedHadronMultiplicityAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Int_t           neutralHadronMultiplicityAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Int_t           photonMultiplicityAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Int_t           electronMultiplicityAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Int_t           muonMultiplicityAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Int_t           HFHadronMultiplicityAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Int_t           HFEMMultiplicityAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         areaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         weightedDz1AK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         weightedDz2AK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         betastarAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         rmsCandsHandAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         jetIdMvaSimpleAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         jetIdMvaFullAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         jetIdMvaPhilV1AK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         nChargedIdMvaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         nNeutralsIdMvaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         dZIdMvaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         dR2MeanIdMvaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         dRMeanIdMvaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         frac01IdMvaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         frac02IdMvaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         frac03IdMvaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         frac04IdMvaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         frac05IdMvaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         betaIdMvaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         betastarIdMvaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         betastarclassicIdMvaAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         chargedEmEnergyAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         neutralEmEnergyAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         combinedSecondaryVertexBJetTagsAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         combinedSecondaryVertexMVABJetTagsAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         jetBProbabilityBJetTagsAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         jetProbabilityBJetTagsAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         simpleSecondaryVertexHighEffBJetTagsAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         simpleSecondaryVertexHighPurBJetTagsAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         trackCountingHighPurBJetTagsAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         trackCountingHighEffBJetTagsAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         trackCountingVeryHighEffBJetTagsAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         rmsCandAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Float_t         ptDAK5PFPUcorrJet[118];   //[nAK5PFPUcorrJet]
    Int_t           nAK5GenJet;
    Int_t           chargeAK5GenJet[44];   //[nAK5GenJet]
    Float_t         energyAK5GenJet[44];   //[nAK5GenJet]
    Float_t         thetaAK5GenJet[44];   //[nAK5GenJet]
    Float_t         etaAK5GenJet[44];   //[nAK5GenJet]
    Float_t         phiAK5GenJet[44];   //[nAK5GenJet]
    Float_t         pxAK5GenJet[44];   //[nAK5GenJet]
    Float_t         pyAK5GenJet[44];   //[nAK5GenJet]
    Float_t         pzAK5GenJet[44];   //[nAK5GenJet]
    Float_t         vertexXAK5GenJet[44];   //[nAK5GenJet]
    Float_t         vertexYAK5GenJet[44];   //[nAK5GenJet]
    Float_t         vertexZAK5GenJet[44];   //[nAK5GenJet]
    Double_t        genPtHat;
  ...
  // used to generate this class and read the Tree.
    if (tree == 0) {
        ...
        chain->Add("/mnt/tier2/store/user/veverka/DYToMuMu_M_20_FSRFilter_8_TuneZ2star_8TeV_pythia6_GEN_SIM_v1/veverka-_step3_RAW2DIGI_L1Reco_RECO_PU_v1-90a3c643a4855c1621ba3bfcbef2e742_VecBosV16-5_2_X/v1/default_MC_1_1_9FG.root/ntp1");
        chain->Add("/mnt/tier2/store/user/veverka/DYToMuMu_M_20_FSRFilter_8_TuneZ2star_8TeV_pythia6_GEN_SIM_v1/veverka-_step3_RAW2DIGI_L1Reco_RECO_PU_v1-90a3c643a4855c1621ba3bfcbef2e742_VecBosV16-5_2_X/v1/default_MC_2_1_7oZ.root/ntp1");
        chain->Add("/mnt/tier2/store/user/veverka/DYToMuMu_M_20_FSRFilter_8_TuneZ2star_8TeV_pythia6_GEN_SIM_v1/veverka-_step3_RAW2DIGI_L1Reco_RECO_PU_v1-90a3c643a4855c1621ba3bfcbef2e742_VecBosV16-5_2_X/v1/default_MC_4_1_B7D.root/ntp1");
  ...
  Int_t VecBosTree::GetEntry(Long64_t entry)
  {
  // Read contents of entry.
    if (!fChain) return 0;
    return fChain->GetEntry(entry);
  }
  Long64_t VecBosTree::LoadTree(Long64_t entry)
  {
  ...
  void VecBosTree::Init(TTree *tree)
  {
  ...
  void VecBosTree::Show(Long64_t entry)
  {
  ...
  Int_t VecBosTree::Cut(Long64_t entry)
  {
