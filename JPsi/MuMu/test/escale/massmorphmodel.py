...
pdf.plotOn(plot)
plot.Draw()
calibrator.w.loadSnapshot('sr_mctruth')
Latex(
    [
...
canvases.next('nll')
nll = pdf.createNLL(data, roo.Range(60, 120))
rframe = phoRes.frame(roo.Range(0.1, 10))
