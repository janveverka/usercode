...
//
// Package:    JPsi/EE
// Class:      CountHistoAnalyzer
//
/**\class CountHistoAnalyzer CountHistoAnalyzer.cc JPsi/EE/plugins/CountHistoAnalyzer.cc
...
// $Id: CountHistoAnalyzer.cc,v 1.2 2010/05/02 19:05:17 veverka Exp $
//
//
...
class CountHistoAnalyzer : public edm::EDAnalyzer {
public:
  explicit CountHistoAnalyzer(const edm::ParameterSet&);
  ~CountHistoAnalyzer();
...
//
CountHistoAnalyzer::CountHistoAnalyzer(const edm::ParameterSet& iConfig):
  h1Container_(),
...
CountHistoAnalyzer::~CountHistoAnalyzer()
{
}
...
void
CountHistoAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void
CountHistoAnalyzer::endJob() {
}

// define this as a plug-in
#include "FWCore/Framework/interface/MakerMacros.h"
DEFINE_FWK_MODULE(CountHistoAnalyzer);
