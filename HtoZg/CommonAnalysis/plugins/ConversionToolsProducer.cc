// -*- C++ -*-
//
// Package:    HtoZg/CommonAnalysis
// Class:      ConversionToolsProducer
//
/**
 * \class ConversionToolsProducer ConversionToolsProducer.cc    
 * \file HtoZg/CommonAnalysis/plugins/ConversionToolsProducer.cc
...
Implementation: Wrapper around RecoEgamma/EgammaTools/interface/ConversionTools.h
  ...
  Originally developed for ElectroWeakAnalysis/MultiBosons
...
} // end of namespace hzg

using cit::hzg::ConversionToolsProducer;
...
//       );
    ...
    ///   defined:
    ///   cd $CMSSW_BASE/src/HtoZg/CommonAnalysis
    ///   touch plugins/ConversionToolsProducer.cc
    ///   scram b USER_CXXFLAGS="-g\ -D=EDM_ML_DEBUG" HtoZg/CommonAnalysis
